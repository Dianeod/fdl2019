ungauged_noforecast_basin:
    ...
    `prev_ppt_7`prev_ppt_8`prev_ppt_9`prev_upstr_ppt_1_1,`prev_upstr_ppt_1_2,
    `prev_upstr_ppt_1_3`prev_upstr_ppt_1_4`prev_upstr_ppt_1_5`prev_upstr_ppt_1_6`prev_upstr_ppt_1_7,
    `prev_upstr_ppt_1_8`prev_upstr_ppt_1_9``x`y`z

gauged_basin:
    `prev_height_1`prev_height_2`prev_height_3`prev_height_4`prev_height_5,
    `prev_height_6`prev_height_7`prev_height_8`prev_height_9,
...
perfect_forecast:
    ...
    `fut_window_ppt_1`fut_window_ppt_2`fut_window_upstr_ppt_1_1`fut_window_upstr_ppt_1_2
