...
/This file takes the following as inputs
/*sdate = start date of requested data
/*edate = ens date of requested data
/*dir   = where to save the splayed table
/*dir2  = where to save the files from usgs
...
if[not count dir2:args`dir2;2"No dir2 argument";exit 4];
